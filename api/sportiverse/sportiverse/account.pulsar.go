...
var (
	...
	fd_Account_hashAccount protoreflect.FieldDescriptor
	fd_Account_creator     protoreflect.FieldDescriptor
)

func init() {
	file_sportiverse_sportiverse_account_proto_init()
	md_Account = File_sportiverse_sportiverse_account_proto.Messages().ByName("Account")
	fd_Account_id = md_Account.Fields().ByName("id")
	fd_Account_hashAccount = md_Account.Fields().ByName("hashAccount")
...
func (x *Account) slowProtoReflect() protoreflect.Message {
	mi := &file_sportiverse_sportiverse_account_proto_msgTypes[0]
...
func (x *fastReflection_Account) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.HashAccount != "" {
		...
		if !f(fd_Account_hashAccount, value) {
			return
		}
	}
	if x.Creator != "" {
...
func (x *fastReflection_Account) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "sportiverse.sportiverse.Account.id":
		return x.Id != uint64(0)
	case "sportiverse.sportiverse.Account.hashAccount":
		return x.HashAccount != ""
	case "sportiverse.sportiverse.Account.creator":
		return x.Creator != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sportiverse.sportiverse.Account"))
		}
		panic(fmt.Errorf("message sportiverse.sportiverse.Account does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Account) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message sportiverse.sportiverse.Account does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Account) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "sportiverse.sportiverse.Account.id":
		panic(fmt.Errorf("field id of message sportiverse.sportiverse.Account is not mutable"))
	case "sportiverse.sportiverse.Account.hashAccount":
		panic(fmt.Errorf("field hashAccount of message sportiverse.sportiverse.Account is not mutable"))
	case "sportiverse.sportiverse.Account.creator":
		panic(fmt.Errorf("field creator of message sportiverse.sportiverse.Account is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: sportiverse.sportiverse.Account"))
		}
...
func (x *fastReflection_Account) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in sportiverse.sportiverse.Account", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Account) Descriptor() ([]byte, []int) {
	return file_sportiverse_sportiverse_account_proto_rawDescGZIP(), []int{0}
}
...
func (x *Account) GetHashAccount() string {
	if x != nil {
		return x.HashAccount
	}
	return ""
...
var File_sportiverse_sportiverse_account_proto protoreflect.FileDescriptor

var file_sportiverse_sportiverse_account_proto_rawDesc = []byte{
	0x0a, 0x25, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x69, 0x76, 0x65, 0x72, 0x73, 0x65, 0x2f, 0x73, 0x70,
	0x6f, 0x72, 0x74, 0x69, 0x76, 0x65, 0x72, 0x73, 0x65, 0x2f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	...
	,
...
var (
	file_sportiverse_sportiverse_account_proto_rawDescOnce sync.Once
	file_sportiverse_sportiverse_account_proto_rawDescData = file_sportiverse_sportiverse_account_proto_rawDesc
)

func file_sportiverse_sportiverse_account_proto_rawDescGZIP() []byte {
	file_sportiverse_sportiverse_account_proto_rawDescOnce.Do(func() {
		file_sportiverse_sportiverse_account_proto_rawDescData = protoimpl.X.CompressGZIP(file_sportiverse_sportiverse_account_proto_rawDescData)
	})
	return file_sportiverse_sportiverse_account_proto_rawDescData
}

var file_sportiverse_sportiverse_account_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_sportiverse_sportiverse_account_proto_goTypes = []interface{}{
	(*Account)(nil), // 0: sportiverse.sportiverse.Account
}
var file_sportiverse_sportiverse_account_proto_depIdxs = []int32{
...
func init() { file_sportiverse_sportiverse_account_proto_init() }
func file_sportiverse_sportiverse_account_proto_init() {
	if File_sportiverse_sportiverse_account_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_sportiverse_sportiverse_account_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_sportiverse_sportiverse_account_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_sportiverse_sportiverse_account_proto_goTypes,
		DependencyIndexes: file_sportiverse_sportiverse_account_proto_depIdxs,
		MessageInfos:      file_sportiverse_sportiverse_account_proto_msgTypes,
	}.Build()
	File_sportiverse_sportiverse_account_proto = out.File
	file_sportiverse_sportiverse_account_proto_rawDesc = nil
	file_sportiverse_sportiverse_account_proto_goTypes = nil
	file_sportiverse_sportiverse_account_proto_depIdxs = nil
}
